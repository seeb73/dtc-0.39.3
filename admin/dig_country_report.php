                                ...
                                if ($product_paid["0"] == "vps")
                                {
                                        ...
                                        for ($i2=0;$i2<$n2;$i2++)
                                        {
                                                ...
                                                for ($i3=0;$i3<$n3;$i3++)
                                                {
                                                        ...
                                                        echo "2-" .  $comp["date"] . "," . $comp_login . "," . ",multipay," . $product_paid["1"] . "." . $product_paid["2"] ."," . $paid_array["price_dollar"] . "\n";
        ...
        else
        {
                ...
                foreach ($countries as $index => $country_code)
                {
                        if ($country_code == $COUNTRY)
                        {
                                ...
                                {
                                        $paid_array = mysqli_fetch_array($r3);
                                        echo $comp["services"] . ", " . $comp["date"] . "," . $comp_login . "," . $comp["domain_name"] . ",single," . $paid_array["name"] ."," . $comp["refund_amount"] . "\n";
                                }
