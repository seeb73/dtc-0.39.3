...
if( isset($_REQUEST["graph"]) ){
	...
	for($i=0;$i<$num_rrd;$i++){
		$rrd_in = "/var/lib/dtc/dtc-xenservers-rrds/".$_REQUEST["vps_server_hostname"]."/".$all_rrd_files[$i];
		$rrd_out = "/var/lib/dtc/dtc-xenservers-rrds/".$_REQUEST["vps_server_hostname"]."/xen".$xen_vps_numbers[$i]."-netout.rrd";
		$cmd .= "DEF:netin$i=$rrd_in:netbytesin:AVERAGE ";
		$cmd .= "DEF:netout$i=$rrd_out:netbytesout:AVERAGE ";
		$cmd .= "CDEF:bitsnetin$i=netin$i,60,/ ";
		$cmd .= "CDEF:bitsnetout$i=netout$i,60,/ ";
