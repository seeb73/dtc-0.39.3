	...
	$out .= dtcDatagrid($dsc);
		...
		$dsc = array(
			...
			"reqdomain" => array(
				...
				"display_replace" => array(_("Yes"),_("No")),
				"default" => "no"),
			"new_account_execution_type" => array(
				"type" => "popup",
				...
				"default" => "none"),
			"new_account_command" => array(
				"type" => "textarea",
				"help" => _("URL or command or mail body to execute or send when a new account of this type is created. To pass custom fields of the product to this, put them as %%%var%%% to be replaced by that custom field."),
