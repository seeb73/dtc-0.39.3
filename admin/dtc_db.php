...
"tables" => array(
	"admin" => array(
		"vars" => array(
			...
			"edit_domain_custom" => "enum('yes','no') NOT NULL default 'no'",
	...
	"config" => array(
		"vars" => array(
			...
			"use_relative_cnames" => "enum('yes','no') NOT NULL default 'no'",
			...
			"ftp_ssh_mode" => "enum('yes','no') NOT NULL default 'no'",
			"ftp_backup_host_ssh" => "varchar(255) NOT NULL default ''",
			"ftp_backup_dest_folder_ssh" => "varchar(255) NOT NULL default '/'",
			"ftp_ftp_mode" => "enum('yes','no') NOT NULL default 'no'",
			"ftp_7z_mode" => "enum('yes','no') NOT NULL default 'no'",
