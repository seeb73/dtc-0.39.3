...
"tables" => array(
	"admin" => array(
		"vars" => array(
			...
			"expire" => "date NOT NULL default '1970-01-01 01:00:00'",
			...
			"restricted_ftp_path" => "enum('no','yes') NOT NULL",
			...
			"resseller_flag" => "enum('no','yes') NOT NULL",
			"ssh_login_flag" => "enum('no','yes') NOT NULL",
			"ftp_login_flag" => "enum('yes','no') NOT NULL default 'yes'",
			"pkg_install_flag" => "enum('yes','no') NOT NULL default 'yes'",
			"edit_domain_custom" => "enum('no','yes') NOT NULL",
	...
	"clients" => array(
		"vars" => array(
			"id" => "int(9) NOT NULL auto_increment",
			"is_company" => "enum('no','yes') NOT NULL",
	...
	"completedorders" => array(
		"vars" => array(
			...
			"date" => "date NOT NULL default '1970-01-01 01:00:00'",
	...
	"companies" => array(
		"vars" => array(
			...
			"text_after" => "text",
			"footer" => "text",
			"in_europe" => "enum('no','yes') NOT NULL"
		),
		"primary" => "(id)"
	),
	"config" => array(
		"vars" => array(
			...
			"send_passwords_in_emails" => "enum('no','yes') NOT NULL",
			...
			"use_relative_cnames" => "enum('no','yes') NOT NULL",
			...
			"use_mail_alias_group" => "enum('yes','no') NOT NULL default 'yes'",
			"use_ssl" => "enum('no','yes') NOT NULL",
			"use_shared_ssl" => "enum('no','yes') NOT NULL",
			"force_use_https" => "enum('yes','no') NOT NULL default 'yes'",
			"use_nated_vhost" => "enum('no','yes') NOT NULL",
			...
			"use_registrar_api" => "enum('no','yes') NOT NULL",
			...
			"ftp_backup_activate" => "enum('no','yes') NOT NULL",
			"ftp_backup_dest_folder" => "varchar(255) NOT NULL default '/'",
			"ftp_active_mode" => "enum('no','yes') NOT NULL",
			"ftp_ssh_mode" => "enum('no','yes') NOT NULL",
			"ftp_backup_host_ssh" => "varchar(255) NOT NULL default ''",
			"ftp_backup_dest_folder_ssh" => "varchar(255) NOT NULL default '/'",
			"ftp_ftp_mode" => "enum('no','yes') NOT NULL",
			"ftp_7z_mode" => "enum('no','yes') NOT NULL",
			"ftp_7z_level" => "enum('fastest','fast','normal','max','ultra') NOT NULL default 'normal'",
			...
			"use_cyrus" => "enum('no','yes') NOT NULL",
			"use_sieve" => "enum('no','yes') NOT NULL",
			"use_amavis" => "enum('yes','no') NOT NULL default 'yes'",
			"use_clamav" => "enum('yes','no') NOT NULL default 'yes'",
			"use_advanced_lists_tunables" => "enum('no','yes') NOT NULL",
			"use_webalizer" => "enum('yes','no') NOT NULL default 'yes'",
			"use_awstats" => "enum('no','yes') NOT NULL",
			"use_visitors" => "enum('no','yes') NOT NULL",
			...
			"provide_own_domain_hosts" => "enum('no','yes') NOT NULL",
			...
			"send_cron_alert" => "enum('no','yes') NOT NULL",
			"restrict_new_account_form" => "enum('no','yes') NOT NULL",
			"new_account_restrict_action" => "enum('show_all_plans','redirect') NOT NULL default 'show_all_plans'",
                        "new_account_restrict_hide_products" => "enum('no','yes') NOT NULL",
			"new_account_restrict_message" => "varchar(255) NOT NULL default 'http://'",
			"send_registration_mail_to_customer" => "enum('yes','no') NOT NULL default 'yes'",
			"registration_mail_subject" => "varchar(255) NOT NULL default 'New Account registered.'",
			"show_affiliation" => "enum('yes','no') NOT NULL default 'yes'",
			"show_ssl_tokens" => "enum('yes','no') NOT NULL default 'yes'",
			"show_remaining_money_on_account" => "enum('yes','no') NOT NULL default 'yes'",
			"show_upgrade_product_button" => "enum('yes','no') NOT NULL default 'yes'",
			...
			"use_cband_user_exceeded_url" => "enum('no','yes') NOT NULL",
	...
	"cron_job" => array(
		"vars" => array(
			"unicrow" => "int(11) NOT NULL default '1'",
			"last_cronjob" => "timestamp NOT NULL default CURRENT_TIMESTAMP",
			"qmail_newu" => "enum('no','yes') NOT NULL",
			"restart_qmail" => "enum('no','yes') NOT NULL",
			"reload_named" => "enum('no','yes') NOT NULL",
			"restart_apache" => "enum('no','yes') NOT NULL",
			"gen_vhosts" => "enum('no','yes') NOT NULL",
			"gen_named" => "enum('no','yes') NOT NULL",
			"gen_reverse" => "enum('no','yes') NOT NULL",
			"gen_fetchmail" => "enum('no','yes') NOT NULL",
			"gen_qmail" => "enum('no','yes') NOT NULL",
			"gen_webalizer" => "enum('no','yes') NOT NULL",
			"gen_backup" => "enum('no','yes') NOT NULL",
			"gen_ssh" => "enum('no','yes') NOT NULL",
			"gen_nagios" => "enum('no','yes') NOT NULL",
			"gen_user_cron" => "enum('no','yes') NOT NULL",
			"lock_flag" => "enum('finished','inprogress') NOT NULL"
		),
		"keys" => array(
			"unicrow" => "(unicrow)"
		),
	...
	"custom_fld" => array(
		"vars" => array(
			...
			"mandatory" => "enum('no','yes') NOT NULL",
			"showonmyaccount" => "enum('no','yes') NOT NULL"
		),
		"primary" => "(id)"
	),
	"custom_heb_types" => array(
		"vars" => array(
			...
			"reqdomain" => "enum('no','yes') NOT NULL",
	...
	"custom_product" => array(
		"vars" => array(
			...
			"start_date" => "date NOT NULL default '1970-01-01 01:00:00'",
			"expire_date" => "date NOT NULL default '1970-01-01 01:00:00'",
	...
	"domain" => array(
		"vars" => array(
			...
			"gen_unresolved_domain_alias" => "enum('no','yes') NOT NULL",
			...
			"stats_login" => "varchar(32) NOT NULL default ''",
  			...
  			"stats_subdomain" => "enum('no','yes') NOT NULL",
  			"wildcard_dns" => "enum('no','yes') NOT NULL",
			...
			"creation_date" => "date NOT NULL default '1970-01-01 01:00:00'",
			"modification_date" => "date NOT NULL default '1970-01-01 01:00:00'",
			"expiration_date" => "date NOT NULL default '1970-01-01 01:00:00'",
	...
	"ftp_access" => array(
		"vars" => array(
			...
			"uid" => "int(5) NOT NULL default '999'",
			"gid" => "int(5) NOT NULL default '999'",
			...
			"ts" => "timestamp NOT NULL default now() on update now()",
			...
			"last_login" => "datetime NOT NULL default '1970-01-01 01:00:00'",
	...
	"groups" => array(
		"vars" => array(
			"gid" => "int(11) NOT NULL default '999'",
	...
	"mailinglist" => array(
		"vars" => array(
			...
			"spammode" => "enum('no','yes') NOT NULL",
			"webarchive" => "enum('no','yes') NOT NULL"
		),
		"primary" => "(id)"
	),
	"nameservers" => array(
	...
	"new_admin" => array(
		"vars" => array(
			...
			"maxmind_output" => "text",
			"last_used_lang" => "varchar(32) NOT NULL default 'en_US.UTF-8'",
			"add_service" => "enum('no','yes') NOT NULL",
			"customfld" => "text",
			"archive" => "enum('no','yes') NOT NULL"
		),
		"primary" => "(id)"
	),
	"paiement" => array(
		"vars" => array(
			...
			"date" => "date NOT NULL default '1970-01-01 01:00:00'",
			"time" => "time NOT NULL default '00:00:00'",
			"valid_date" => "date NOT NULL default '1970-01-01 01:00:00'",
	...
	"pending_renewal" => array(
		"vars" => array(
			"id" => "int(11) NOT NULL auto_increment",
			"adm_login" => "varchar(64) NOT NULL default ''",
			"renew_date" => "date NOT NULL default '1970-01-01 01:00:00'",
	...
	"pop_access" => array(
		"vars" => array(
			"autoinc" => "int(12) NOT NULL auto_increment",
			"id" => "varchar(32) NOT NULL default ''",
			"uid" => "int(11) NOT NULL default '999'",
			"gid" => "int(11) NOT NULL default '999'",
			...
			"iwall_protect" => "enum('no','yes') NOT NULL",
			"bounce_msg" => "text character set utf8 collate utf8_bin NOT NULL",
			"spf_protect" => "enum('no','yes') NOT NULL",
			"clamav_protect" => "enum('no','yes') NOT NULL",
			"fullemail" => "varchar(255) NOT NULL default 'none'",
			"spam_mailbox_enable" => "enum('no','yes') NOT NULL",
			"spam_mailbox" => "varchar(255) NOT NULL default 'SPAM'",
			"virus_lover" => "enum('Y','N') NOT NULL default 'Y'",
			"spam_lover" => "enum('Y','N') NOT NULL default 'Y'",
			"banned_files_lover" => "enum('Y','N') NOT NULL default 'Y'",
			"bad_header_lover" => "enum('Y','N') NOT NULL default 'Y'",
			"spam_tag_level" => "float(5,2) NOT NULL default '-999.00'",
			"spam_tag2_level" => "float(5,2) NOT NULL default '4.30'",
			"spam_tag3_level" => "float(5,2) NOT NULL default '5.00'",
			"spam_kill_level" => "float(5,2) NOT NULL default '6.00'",
			"spam_dsn_cutoff_level" => "float(5,2) NOT NULL default '6.00'",
			"quarantine_cutoff_level" => "float(5,2) NOT NULL default '20.00'",
			"spam_modifies_subj" => "char(1) NOT NULL default 'Y'",
			"spam_subject_tag" => "varchar(255) NOT NULL default ''",
			"spam_subject_tag2" => "varchar(255) NOT NULL default '***SPAM*** '",
			"spam_subject_tag3" => "varchar(255) NOT NULL default '***SPAM*** '",
			"newvirus_admin" => "varchar(64) NOT NULL default ''",
			"virus_admin" => "varchar(64) NOT NULL default ''",
			"spam_admin" => "varchar(64) NOT NULL default ''",
			"banned_admin" => "varchar(64) NOT NULL default ''",
			"bad_header_admin" => "varchar(64) NOT NULL default ''",
			"virus_quarantine_to" => "varchar(64) NOT NULL default ''",
			"spam_quarantine_to" => "varchar(64) NOT NULL default ''",
			"banned_quarantine_to" => "varchar(64) NOT NULL default ''",
			"bad_header_quarantine_to" => "varchar(64) NOT NULL default ''",
			"clean_quarantine_to" => "varchar(64) NOT NULL default ''",
			"archive_quarantine_to" => "varchar(64) NOT NULL default ''",
			"message_size_limit" => "int(12) NOT NULL default '0'",
			"addr_extension_virus" => "varchar(64) NOT NULL default ''",
			"addr_extension_spam" => "varchar(64) NOT NULL default ''",
			"addr_extension_banned" => "varchar(64) NOT NULL default ''",
			"addr_extension_bad_header" => "varchar(64) NOT NULL default ''",
			"pass_next_req" => "varchar(128) NOT NULL default ''",
			"pass_expire" => "int(12) NOT NULL default '0'",
			"vacation_flag" => "enum('no','yes') NOT NULL",
			"vacation_text" => "text",
	...
	"product" => array(
		"vars" => array(
			...
			"private" => "enum('no','yes') NOT NULL",
			"use_radius" => "enum('no','yes') NOT NULL",
			"custom_heb_type" => "int(11) NOT NULL default '0'",
			"custom_heb_type_fld" => "text",
	...
	"radacct" => array(
		"vars" => array(
			...
			"AcctStartTime" => "datetime NOT NULL default '1970-01-01 01:00:00'",
			"AcctStopTime" => "datetime default NULL",
			"AcctSessionTime" => "int(12) default NULL",
			"AcctAuthentic" => "varchar(32) default NULL",
			"ConnectInfo_start" => "varchar(255) default NULL",
			"ConnectInfo_stop" => "varchar(255) default NULL",
	...
	"secpayconf" => array(
		"vars" => array(
			...
			"use_products_for_renewal" => "enum('no','yes') NOT NULL",
			"use_paypal" => "enum('no','yes') NOT NULL",
			...
			"moneybookers_sandbox" => "enum('no','yes') NOT NULL",
			...
			"use_enets" => "enum('no','yes') NOT NULL",
			...
			"use_maxmind" => "enum('no','yes') NOT NULL",
			...
			"accept_wiretransfers" => "enum('no','yes') NOT NULL",
			...
			"accept_westernunion" => "enum('no','yes') NOT NULL",
			...
			"use_cuentadigital" => "enum('no','yes') NOT NULL",
			...
			"cuentadigital_replacelogin" => "enum('no','yes') NOT NULL",
	...
	"smtp_logs" => array(
		"vars" => array(
			...
			"delivery_success" => "enum('no','yes') NOT NULL",
	...
	"spent_moneyout" => array(
		"vars" => array(
			...
			"invoice_date" => "date NOT NULL default '1970-01-01 01:00:00'",
			"paid_date" => "date NOT NULL default '1970-01-01 01:00:00'",
			"time" => "time NOT NULL default '00:00:00'",
			"vat_rate" => "decimal(9,2) NOT NULL default '0.00'",
			"vat_total" => "decimal(9,2) NOT NULL default '0.00'",
	...
	"subdomain" => array(
		"vars" => array(
			...
			"sbox_protect" => "enum('yes','no') NOT NULL default 'yes'",
			"shared_hosting_security" => "enum('mod_php','sbox_copy','sbox_aufs') NOT NULL default 'mod_php'",
			"shared_hosting_varwww_docroot" => "enum('no','yes') NOT NULL",
			"domain_name" => "varchar(255) NOT NULL default ''",
			...
			"register_globals" => "enum('no','yes') NOT NULL",
			"login" => "varchar(16) default NULL",
			"pass" => "varchar(64) default NULL",
			"w3_alias" => "enum('no','yes') NOT NULL",
			...
			"php_allow_url_fopen"=> "enum('no','yes') NOT NULL",
			"php_post_max_size"=> "int(11) NOT NULL default '8'",
			"php_session_auto_start"=> "enum('no','yes') NOT NULL",
	...
	"tik_queries" => array(
		"vars" => array(
			...
			"got_reply" => "enum('no','yes') NOT NULL",
			...
			"request_close" => "enum('no','yes') NOT NULL",
			"customer_email" => "varchar(255) NOT NULL default ''",
			"closed" => "enum('no','yes') NOT NULL",
	...
	"vps" => array(
		"vars" => array(
			...
			"installed" => "enum('no','yes') NOT NULL",
			"bsdkernel" => "enum('normal','install') NOT NULL default 'normal'",
			"monitoring_email" => "varchar(255) NOT NULL default ''",
			"monitor_ping" => "enum('no','yes') NOT NULL",
			"monitor_ssh" => "enum('no','yes') NOT NULL",
			"monitor_http" => "enum('no','yes') NOT NULL",
			"monitor_smtp" => "enum('no','yes') NOT NULL",
			"monitor_pop3" => "enum('no','yes') NOT NULL",
			"monitor_imap4" => "enum('no','yes') NOT NULL",
			"monitor_ftp" => "enum('no','yes') NOT NULL",
	...
	"vps_stats" => array(
		"vars" => array(
			...
			"tresh_before_warn_sent" => "enum('no','yes') NOT NULL",
			"tresh_quota_reached_warn_sent" => "enum('no','yes') NOT NULL",
			"tresh_vps_shutdown" => "enum('no','yes') NOT NULL"
		),
