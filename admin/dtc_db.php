...
"tables" => array(
	...
	"pop_access" => array(
		"vars" => array(
			...
			"virus_lover" => "enum('Y','N') NOT NULL default 'N'",
			"spam_lover" => "enum('Y','N') NOT NULL default 'N'",
			"banned_files_lover" => "enum('Y','N') NOT NULL default 'N'",
			"bad_header_lover" => "enum('Y','N') NOT NULL default 'N'",
			"spam_tag_level" => "float(5,2) NOT NULL default '3.00'",
			...
			"spam_subject_tag" => "varchar(255) NOT NULL default '[possible spam] '",
			"spam_subject_tag2" => "varchar(255) NOT NULL default '***SPAM*** _SCORE_ (_REQD_) '",
			"spam_subject_tag3" => "varchar(255) NOT NULL default '***BLATANT*SPAM*** _SCORE_ '",
			...
			"message_size_limit" => "int(12) default NULL",
