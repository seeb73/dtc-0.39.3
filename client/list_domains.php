...
case "list_mx_recipients":
	...
	for($i=0;$i<$n;$i++){
		...
		$r_email = mysqli_query($mysql_connection,$q_email)or die("Cannot query $q_email ! line: ".__LINE__." file: ".__FILE__." sql said: ".mysql_error());
		...
		$r_mailinglist =  mysqli_query($mysql_connection,$q_mailinglist)or die("Cannot query $q_mailinglist ! line: ".__LINE__." file: ".__FILE__." sql said: ".mysql_error());
		...
		$r_groups = mysqli_query($mysql_connection,$q_groups)or die ("Cannot query $q_groups line: ".__LINE__." file ".__FILE__." sql said: ".mysql_error());
