...
Server said: <i>" . $regz["response_text"] . "</i>");
	...
	$query = "UPDATE $pro_mysql_domain_table SET primary_dns='$new_dns_1',other_dns='$new_dns_2',primary_mx='$new_mx_1',other_mx='$new_mx_2',txt_root_entry='".mysql_real_escape_string($_REQUEST["txt_root_entry"])."',txt_root_entry2='".mysql_real_escape_string($_REQUEST["txt_root_entry2"])."',spf_txt_entry='".mysql_real_escape_string($_REQUEST["spf_txt_entry"])."' WHERE owner='$adm_login' AND name='$edit_domain';";
